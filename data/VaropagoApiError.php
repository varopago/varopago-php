 ...
 */
class VaropagoApiError extends Exception
{
...
class VaropagoApiAuthError extends VaropagoApiError
{
    
}

// Request related Error
class VaropagoApiRequestError extends VaropagoApiError
{
    
}

// Transaction related Errors
class VaropagoApiTransactionError extends VaropagoApiError
{
    
}

// Connection related Errors
class VaropagoApiConnectionError extends VaropagoApiError
{
